...
export const loginForm = [
  {
    ...
    type: "email",
    id: "email",
    helpText: "The email value must be a valid stud.noroff.no email",
  },
  {
    label: "Password",
    type: "password",
...
export const registerForm = [
  ...
  },
  {
    ...
    type: "text",
    id: "username",
    helpText: "We'll never share your username with anyone else...",
  },
  {
    label: "Password",
    type: "password",
  ...
  },
  {
    ...
    type: "password",
    id: "repeat-password",
    helpText: "Your password is safe with us..",
  },
];

export const submitBidForm = [
  { label: "Bid", type: "number", id: "bid", helpText: "" },
];
...
export const createListingFormTextInputs = [
  ...
  },
  {
    ...
    type: "textarea",
    id: "description",
    helpText: "Enter a description for your listing",
  },
];
...
export const createlistingFormDateInput = [
  {
    ...
    type: "datetime-local",
    id: "end-date",
    helpText: "Enter the end date for your listing",
  },
];
...
export const updateAvatarFormInput = [
  {
    label: "Avatar",
    type: "text",
    id: "avatar-form-input",
    helpText: "Enter a image url",
  },
];
