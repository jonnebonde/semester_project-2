export function renderProfileInfo(profileInfo) {
  ...
  profileAvatarContainer.classList.add("profile-avatar-container", "col-12","col-md-6", "d-flex", "justify-content-md-end", "justify-content-center");
  ...
  profileCredentialsContainer.classList.add("profile-credentials-container", "col-12","col-md-6", "d-flex", "flex-column", "text-break", "align-items-center", "align-items-md-start");
