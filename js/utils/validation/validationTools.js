...
export function validateUserName(name, minLength, maxLength) {
  ...
  if (name.length < minLength) {
    displayMessage(
      "error",
      `Name is too short. It should be at least ${minLength} characters long.`,
    ...
    displayMessage(
      "error",
      `Name is too long. It should be at most ${maxLength} characters long.`,
      ".username-message-container",
    );
    ...
    displayMessage(
      "error",
      `Name contains disallowed symbols or characters.`,
      ".username-message-container",
    );
